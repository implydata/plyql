...
declare module "vogievetsky-mysql2" {
  ...
  interface IServer {
    listen(port: number, host?: string, backlog?: any, callback?: Function): IServer;
    close(callback?: Function): IServer

    on(ev: string, callback: (...args: any[]) => void): IServer;
    on(ev: 'connection', callback: (connection: IConnection) => void): IServer;
  }
